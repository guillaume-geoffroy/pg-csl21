...
We will now exploit this structure to define, for each type $A$ of $\STLC$, a generalised partial metric on the closed (exact) programs of type $A$. % space $(\Lambda_{A}/\oeq_{A}, \distances{A}, d_{A})$.
