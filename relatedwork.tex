...
Westbrook and Chauduri \cite{chaudhuri} have introduced a more syntactic approach to approximate program transformations through a System F-based type system with a type of real numbers and an explicit distinction between exact and approximate programs.
