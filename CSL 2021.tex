...
\title{Diameter spaces: a partial metric semantics of higher-order programs and approximate program transformations} %TODO Please add
...
\newcommand{\dsp}{\operatorname{DiameterSpaces}}
