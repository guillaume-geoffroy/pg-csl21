...
\title{Distances between higher-order programs as quantale-valued partial metrics}

\titlerunning{Distances between programs as partial metrics} % optional, please use if title is longer than one line
