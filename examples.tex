...
differentiable or integrable (see Remark \ref{rem:continuous}), we can consider extension of $\STLC$ with explicit differential or integral operators, as is done for example in $\mathsf{Real\ PCF}$ \cite{Di-Gianantonio:2013aa, Edalat:2000aa}.
